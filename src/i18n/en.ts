export const en = {
  ...
  format: {
    label: "02",
    heading: "Format and Logistics",
    card1_title: "Bi-weekly cadence",
    card1_body:
      "Sessions take place every two weeks, balancing frequency with quality.",
    card2_title: "Hybrid format",
    card2_body:
      "Each cycle includes one hybrid on-site session (with snacks) and one fully remote session via Google Meet.",
    card3_title: "Typical slots",
    card3_body:
      "Sessions generally run at 9:00 AM CST or 5:00 PM CST. Each invite confirms the exact time.",
  },
  why: {
    ...
    items: [
      ...
      {
        number: "03",
        title: "Speaker Growth",
        body: "The initiative doubles as a speaker factory. Participants develop storytelling, public speaking, and communication skills that matter for career progression.",
      },
      {
        number: "04",
  ...
  community_gallery: {
    tabs_label: "Community updates",
    tab_original: "Community collage",
    tab_bogota: "New · Bogotá + GDG",
    original_label: "Community",
    original_heading: "What AI at Work feels like",
    original_body: "It is not just decks and demos. It is live questions, close conversations, and sessions that actually feel like a learning community.",
    original_chips: ["Bogotá", "Hybrid talks", "Live Q&A"],
    original_quote_label: "The energy",
    original_quote: "The best part is that the conversation keeps going after the presentation ends.",
    original_photo1_alt: "Speaker presenting at AI at Work in front of attendees at the Wizeline Bogotá office.",
    original_photo2_alt: "Audience attending an AI at Work session with the city view in the background.",
    original_photo3_alt: "Panel conversation during an AI at Work session with the book Algoritmos Deshumanizantes in the foreground.",
    label: "AI at Work Bogotá · First session",
    heading: "Beyond the prompt, into the community",
    body: "Our first Bogotá session, created with Google Developer Group Bogotá, brought Wizeliners and members of the external tech community together to learn, exchange ideas, and explore how AI is already transforming the way we work.",
    details: "Wizeline speakers Kimberly Moreno and Dan López shared a marketing use case and built an AI-powered Threads bot live, showing how an idea can evolve from strategy into automation with Gemini. GDG Bogotá brought the community perspective and shared how they are helping connect Colombia's tech ecosystem.",
    thanks: "Made possible by the AI at Work team and the Bogotá office community.",
    chips: ["Bogotá", "GDG Bogotá", "Gemini", "Community"],
    quote_label: "What AI at Work is about",
    quote: "Creating spaces to share what we are building and learning, learn from each other, and grow together as we explore what AI can enable in our day-to-day work.",
    photo1_alt:
      "Group photo of Wizeliners and GDG Bogotá community members at the first AI at Work Bogotá session.",
    photo2_alt:
      "Live demonstration of an AI-powered Threads bot during AI at Work Bogotá.",
    photo3_alt:
      "Google Developer Group Bogotá sharing its work with the local tech community.",
    photo4_alt: "Speaker presenting a Gemini use case at AI at Work Bogotá.",
    photo5_alt: "Kimberly Moreno and Dan López presenting at AI at Work Bogotá.",
    photo6_alt: "Community selfie during the first AI at Work Bogotá session.",
    photo7_alt: "Attendees listening and exchanging ideas at the Bogotá office.",
    photo8_alt: "Beyond the Prompt session title displayed at AI at Work Bogotá.",
  },
  articles_teaser: {
    label: "03",
  ...
  newsletter_section: {
    ...
    subtitle:
      "Subscribe to receive session announcements, speaker spotlights, and resources directly to your inbox.",
    placeholder: "your.email@wizeline.com",
    button: "Subscribe",
