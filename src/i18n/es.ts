export const es = {
  ...
  format: {
    label: "02",
    heading: "Formato y logística",
    card1_title: "Cadencia quincenal",
    card1_body:
      "Las sesiones se realizan cada dos semanas, equilibrando frecuencia con calidad.",
    card2_title: "Formato híbrido",
    card2_body:
      "Cada ciclo incluye una sesión híbrida presencial (con snacks) y una sesión completamente remota por Google Meet.",
    card3_title: "Horarios típicos",
    card3_body:
      "Las sesiones generalmente se realizan a las 9:00 AM CST o 5:00 PM CST. Cada invitación confirma la hora exacta.",
  },
  why: {
    heading: "Por qué participar",
    items: [
      {
        number: "01",
      ...
      {
        number: "03",
        title: "Crecimiento como speaker",
        body: "La iniciativa funciona también como una fábrica de speakers. Los participantes desarrollan habilidades de storytelling, oratoria y comunicación que importan para la progresión profesional.",
      },
      {
        number: "04",
  ...
  community_gallery: {
    tabs_label: "Actualizaciones de la comunidad",
    tab_original: "Collage de comunidad",
    tab_bogota: "Nuevo · Bogotá + GDG",
    original_label: "Comunidad",
    original_heading: "Así se vive AI at Work",
    original_body: "No son solo slides y demos. También son preguntas en vivo, conversaciones cercanas y sesiones que se sienten como comunidad.",
    original_chips: ["Bogotá", "Charlas híbridas", "Preguntas en vivo"],
    original_quote_label: "La vibra",
    original_quote: "La charla sigue incluso cuando la presentación ya terminó.",
    original_photo1_alt: "Speaker presentando en AI at Work frente a la audiencia en la oficina de Wizeline Bogotá.",
    original_photo2_alt: "Audiencia asistiendo a una sesión de AI at Work con vista a la ciudad de fondo.",
    original_photo3_alt: "Conversación de panel durante una sesión de AI at Work con el libro Algoritmos Deshumanizantes en primer plano.",
    label: "AI at Work Bogotá · Primera sesión",
    heading: "Más allá del prompt, hacia la comunidad",
    body: "Nuestra primera sesión en Bogotá, realizada junto a Google Developer Group Bogotá, reunió a Wizeliners y miembros de la comunidad tech para aprender, intercambiar ideas y explorar cómo la IA ya está transformando nuestra forma de trabajar.",
    details: "Kimberly Moreno y Dan López compartieron un caso de uso de marketing y construyeron en vivo un bot de Threads impulsado por IA, mostrando cómo una idea puede pasar de la estrategia a la automatización con Gemini. GDG Bogotá aportó la perspectiva de comunidad y compartió su trabajo conectando el ecosistema tecnológico de Colombia.",
    thanks: "Hecho posible gracias al equipo de AI at Work y a la comunidad de la oficina de Bogotá.",
    chips: ["Bogotá", "GDG Bogotá", "Gemini", "Comunidad"],
    quote_label: "De esto se trata AI at Work",
    quote: "Crear espacios para compartir lo que estamos construyendo y aprendiendo, aprender unos de otros y crecer juntos mientras exploramos lo que la IA puede habilitar en nuestro trabajo diario.",
    photo1_alt:
      "Foto grupal de Wizeliners y miembros de GDG Bogotá en la primera sesión de AI at Work Bogotá.",
    photo2_alt:
      "Demostración en vivo de un bot de Threads impulsado por IA durante AI at Work Bogotá.",
    photo3_alt:
      "Google Developer Group Bogotá compartiendo su trabajo con la comunidad tecnológica local.",
    photo4_alt: "Speaker presentando un caso de uso con Gemini en AI at Work Bogotá.",
    photo5_alt: "Kimberly Moreno y Dan López presentando en AI at Work Bogotá.",
    photo6_alt: "Selfie de la comunidad durante la primera sesión de AI at Work Bogotá.",
    photo7_alt: "Asistentes escuchando e intercambiando ideas en la oficina de Bogotá.",
    photo8_alt: "Título de la sesión Beyond the Prompt proyectado en AI at Work Bogotá.",
  },
  articles_teaser: {
    label: "03",
    ...
    subtitle:
      "Estamos preparando una nueva capa para AI at Work: piezas escritas con ideas prácticas, perspectivas técnicas y aprendizajes que queremos seguir moviendo más allá de cada sesión en vivo.",
    items: [
      {
  ...
  upcoming: {
    ...
    label: "Agenda",
    happening_soon: "Próximamente",
    remote: "Remoto",
    speakers_label: "Speakers",
    host_label: "Host",
    empty: "No hay próximas sesiones programadas.",
    view_all: "Ver todas las sesiones",
  },
  featured: {
    label: "Últimas sesiones",
  ...
  newsletter_section: {
    ...
    subtitle:
      "Suscríbete para recibir anuncios de sesiones, destacados de speakers y recursos directamente en tu bandeja.",
    placeholder: "tu.correo@wizeline.com",
    button: "Suscribirme",
  ...
  about_page: {
    ...
    cta_feedback_title: "Dar feedback",
    cta_feedback_body:
      "Tu opinión ayuda a mejorar el formato, los temas y la experiencia general de AI at Work.",
  },
  newsletter_page: {
    title: "Archivo del Newsletter",
    read_issue: "Leer número",
  },
};
